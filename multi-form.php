<?php
/*
Plugin Name: WP Multi Form
Description: A plugin to create a multi-step form and store data in custom database tables.
Version: 1.0
Author: Payal Sharma
*/
...
// Step 1: Create Database Table on Plugin Activation
function wpmsf_create_tables() {
    global $wpdb;
    $charset_collate = $wpdb->get_charset_collate();
    $form_data_table = $wpdb->prefix . 'multiform_data';
    $sql = "CREATE TABLE IF NOT EXISTS $form_data_table (
        ...
        business_type varchar(50) DEFAULT '' NOT NULL,
        services varchar(255) DEFAULT '' NOT NULL,
        survey_method varchar(255) DEFAULT '' NOT NULL,
        important_aspects varchar(255) DEFAULT '' NOT NULL,
        selected_state varchar(50) DEFAULT '' NOT NULL,
        payment_method varchar(255) DEFAULT '' NOT NULL,
        orders_per_month varchar(255) DEFAULT '' NOT NULL, 
        selected_pricing_plan varchar(255) DEFAULT '' NOT NULL,
...
// Step 2: Display Multi-Step Form with Shortcode
function wpmsf_display_form() {
    ob_start();
    ...
    <div id="multi-step-form">
        ...
        <div id="step-1" class="form-step">
            <h2>Create your Ensite account</h2>
            <p class="below-heading">Before we get your account created we need to know a few details about your business.</p>
            <p class="main-question">Select your business type:</p>
            <div class="form-options">
            <button onclick="nextStep(2, 'full stack solar installer')" class="step1-options">
                <img src="<?php echo plugin_dir_url( __FILE__ ); ?>images/full-stack.svg" alt="Full Stack Solar Installer" width="20" height="20" />We're a full stack solar installer</button>
            <button onclick="nextStep(2, 'EPC')" class="step1-options">
            <img src="<?php echo plugin_dir_url( __FILE__ ); ?>images/epc.svg" alt="EPC" width="20" height="20" />We're an EPC</button>
            </div>
            <div class="form-options">
            <button onclick="nextStep(2, 'sales company/dealer')" class="step1-options">
            <img src="<?php echo plugin_dir_url( __FILE__ ); ?>images/dealer.svg" alt="Dealer" width="20" height="20" />We're a sales company/dealer</button>
            <button onclick="nextStep(2, 'other')" class="step1-options">
            <img src="<?php echo plugin_dir_url( __FILE__ ); ?>images/other.svg" alt="Other" width="20" height="20" />Other
            </button>
            </div>
        </div>
        ...
        <div id="step-2" class="form-step" style="display: none;">
            <h2>Create your Ensite account</h2>
            <p class="main-question">Please provide your contact info:</p>
            <form id="contact-info-form">
                <input type="hidden" name="business_type" id="business_type">
                
                <input type="text" placeholder="Company Name" name="company_name" id="company_name" required oninput="validateStep2()">
                <span class="error-message" id="company_name_error"></span>
                <input type="text" placeholder="First & Last Name" name="full_name" id="full_name" required oninput="validateStep2()">
                <span class="error-message" id="full_name_error"></span>
                <input type="number" placeholder="Phone Number" name="phone_number" id="phone_number" required maxlength="10" oninput="validateStep2()">
                <span class="error-message" id="phone_number_error"></span>
                <input type="email" placeholder="Work Email" name="email" id="email" required oninput="validateStep2()">
                <span class="error-message" id="email_error"></span>
                <div class="buttons-back-continue">
                 <!-- Back and Continue Buttons -->
                <button type="button" id="back-btn" onclick="prevStep(1)">Back</button>
                <button type="button" id="continue-btn" onclick="validateStep2()">Continue</button>
</div>
            </form>
        </div>

        <!-- Step 3: Services Selection with Checkboxes -->
        <div id="step-3" class="form-step" style="display: none;">
            <h2>Create your Ensite account</h2>
            <p class="main-question">What services are you interested in using Ensite for?</p>
            <form id="services-form" onsubmit="saveData(event)">
            <div class="form-options">
            <label class="custom-checkbox">
                <input type="checkbox" name="services[]" class="service-checkbox" value="Site Surveys" onclick="selectService(this)" style="display:none;">
                    <span class="checkbox-text"><img src="<?php echo plugin_dir_url( __FILE__ ); ?>images/site.svg" alt="site" width="20" height="20" />Site Surveys</span> </label><br>
            <label class="custom-checkbox">
                <input type="checkbox" name="services[]" class="service-checkbox" value="Design & Engineering" onclick="selectService(this)" style="display:none;">
                    <span class="checkbox-text"><img src="<?php echo plugin_dir_url( __FILE__ ); ?>images/design.svg" alt="design" width="20" height="20" /> Design & Engineering</span> </label><br>
</div>
<div class="form-options">
            <label class="custom-checkbox">
                <input type="checkbox" name="services[]" class="service-checkbox" value="Permitting & Interconnection" onclick="selectService(this)" style="display:none;">
                    <span class="checkbox-text"><img src="<?php echo plugin_dir_url( __FILE__ ); ?>images/permitting.svg" alt="permitting" width="20" height="20" /> Permitting & Interconnection</span> </label><br>
            <label class="custom-checkbox">
                <input type="checkbox" name="services[]" class="service-checkbox" value="Final Inspection Sits" onclick="selectService(this)" style="display:none;">
                    <span class="checkbox-text"><img src="<?php echo plugin_dir_url( __FILE__ ); ?>images/final.svg" alt="final" width="20" height="20" /> Final Inspection Sites</span> </label><br>
</div>
             <span class="error-message" id="services_error"></span>
             <div class="buttons-back-continue">
             <button type="button" onclick="nextStep(2)" id="step3-back-btn">Back</button>
             <button type="button" id="step3-continue-btn">Continue</button>
</div>
             <!-- <button type="button" onclick="nextStep(4)" id="step3-continue-btn">Continue</button> -->
            </form>
        </div>

        <!-- Step 4: Survey Method Selection with Single-Selection Button Options -->
        <div id="step-4" class="form-step" style="display: none;">
            <h2>Create your Ensite account</h2>
            <p class="main-question">How are your surveys currently being done?</p>
            <form id="survey-method-form" onsubmit="saveData(event)">
            <div class="form-options">
                <label class="custom-checkbox">
                    <input type="checkbox" name="survey_methods[]" value="Sales reps do them" onclick="selectSurveyMethod(this)" style="display: none;">
                        <span class="checkbox-text"><img src="<?php echo plugin_dir_url( __FILE__ ); ?>images/sales.svg" alt="Sales" width="20" height="20" />
                        Sales reps do them</span>
                </label><br>
                <label class="custom-checkbox">
                    <input type="checkbox" name="survey_methods[]" value="Installers do them" onclick="selectSurveyMethod(this)" style="display: none;">
                        <span class="checkbox-text"><img src="<?php echo plugin_dir_url( __FILE__ ); ?>images/installer.svg" alt="installer" width="20" height="20" />
                        Installers do them</span>
                </label><br>
</div>
<div class="form-options">
                <label class="custom-checkbox">
                    <input type="checkbox" name="survey_methods[]" value="Dedicated survey techs" onclick="selectSurveyMethod(this)" style="display: none;">
                        <span class="checkbox-text"><img src="<?php echo plugin_dir_url( __FILE__ ); ?>images/survey.svg" alt="survey" width="20" height="20" />
                        Dedicated survey techs</span>
                </label><br>
                <label class="custom-checkbox">
                    <input type="checkbox" name="survey_methods[]" value="We use a third party" onclick="selectSurveyMethod(this)" style="display: none;">
                        <span class="checkbox-text"><img src="<?php echo plugin_dir_url( __FILE__ ); ?>images/third.svg" alt="third" width="20" height="20" />
                        We use a third party</span>
                </label><br>
</div>
                <span class="error-message" id="survey-error-message" style="display:none;"></span> 
                <div class="buttons-back-continue">
                <button type="button" onclick="prevStep(3)">Back</button>
                <button type="button" id="step4-continue-btn">Continue</button>
</div>
                <!-- <button type="button" onclick="nextStep(5)">Continue</button> -->
            </form>
        </div>

        <!-- Step 5: Important Aspects Selection -->
        <div id="step-5" class="form-step" style="display: none;">
        <h2>Create your Ensite account</h2>
            <p class="main-question">What aspects of these services are most important to you? (Select up to 2)</p>
            <form id="important-aspects-form" onsubmit="saveData(event)">
            <div class="form-options">
                <label class="custom-checkbox">
                    <input type="checkbox" name="important_aspects[]" value="Fast turnaround times" onclick="limitSelection(this, 2)" style="display:none;">
                    <span class="checkbox-text"><img src="<?php echo plugin_dir_url( __FILE__ ); ?>images/times.svg" alt="times" width="20" height="20" />Fast turnaround times</span>
                </label><br>
                <label class="custom-checkbox">
                    <input type="checkbox" name="important_aspects[]" value="Coverage in our market" onclick="limitSelection(this, 2)" style="display:none;">
                    <span class="checkbox-text"><img src="<?php echo plugin_dir_url( __FILE__ ); ?>images/market.svg" alt="market" width="20" height="20" />Coverage in our market</span>
                </label><br>
</div>
<div class="form-options">
                <label class="custom-checkbox">
                    <input type="checkbox" name="important_aspects[]" value="Saving as much as possible" onclick="limitSelection(this, 2)" style="display:none;">
                    <span class="checkbox-text"><img src="<?php echo plugin_dir_url( __FILE__ ); ?>images/saving.svg" alt="saving" width="20" height="20" />Saving as much as possible</span>
                </label><br>
                <label class="custom-checkbox">
                    <input type="checkbox" name="important_aspects[]" value="Quality" onclick="limitSelection(this, 2)" style="display:none;">
                    <span class="checkbox-text"><img src="<?php echo plugin_dir_url( __FILE__ ); ?>images/quality.svg" alt="quality" width="20" height="20" />Quality</span>
                </label><br>
</div>
                <span class="error-message" id="important_aspects_error"></span>
                <div class="buttons-back-continue">
                <button type="button" onclick="prevStep(4)">Back</button>
                <button type="button" id="step5-continue-btn">Continue</button>
</div>
         ...
         <div id="step-6" class="form-step" style="display: none;">
          <h2>Create your Ensite account</h2>
            <p class="main-question">What states do you currently do business in?</p>
            <form method="POST" onsubmit="saveData(event)">
            <input type="hidden" id="selected-state" name="selected_state" />

            <p class="States-selected">Selected states: <div id="state-name"></div></p>
                <div id="usa-map" style="width: 100%; height: 400px;">
                <svg
            ...
            <sodipodi:namedview
                ...
                <path class="state"
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="FL"
                ...
                <text class="state-text" style="fill:#184a5b;" x="750" y="480" font-size="15">FL</text>
                <path class="state"
                style="fill:#ffffff;fill-opacity:1;stroke:#184a5b;stroke-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="NH"
                ...
                <text class="state-text" style="fill:#184a5b;" x="857" y="140" font-size="11">NH</text>
            <path class="state"
                ...
                id="MI-"
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none" />
                <text class="state-text" style="fill:#184a5b;" x="650" y="175" font-size="12px">MI</text>
                <path
                style="fill:#ffffff;fill-opacity:1;stroke:#184a5b;stroke-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="VT" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="842" y="130" font-size="10">VT</text>
                <path
                style="fill:#ffffff;fill-opacity:1;stroke:#184a5b;stroke-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="ME" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="888" y="78" font-size="12">ME</text>
                <path
                style="fill:#ffffff;fill-opacity:1;stroke:#184a5b;stroke-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="RI" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="872" y="172" font-size="9">RI</text>
            <path
                style="fill:#ffffff;fill-opacity:1;stroke:#184a5b;stroke-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="NY" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="805" y="165" font-size="12">NY</text>
            <path
                style="fill:#ffffff;fill-opacity:1;stroke:#184a5b;stroke-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="PA" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="782" y="210" font-size="12">PA</text>
            <path
                style="fill:#ffffff;fill-opacity:1;stroke:#184a5b;stroke-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="NJ" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="829" y="210" font-size="10">NJ</text>
            <path
                style="fill:#ffffff;fill-opacity:1;stroke:#184a5b;stroke-opacity:1;stroke-linecap:butt;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="DE" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="827" y="245" font-size="12px">DE</text>
            <path
                style="fill:#ffffff;fill-opacity:1;stroke:#184a5b;stroke-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="MD" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="798" y="240" font-size="9px">MD</text>
            <path
                style="fill:#ffffff;fill-opacity:1;stroke:#184a5b;stroke-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="VA" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="785" y="280" font-size="12px">VA</text>
            <path
                style="fill:#ffffff;fill-opacity:1;stroke:#184a5b;stroke-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="WV" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="735" y="270" font-size="12px">WV</text>
            <path
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="OH" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="690" y="240" font-size="12px">OH</text>
            <path
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="IN" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="640" y="270" font-size="12px">IN</text>
            <path
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="IL" class="state"
                ...
                sodipodi:nodetypes="ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc" />
                <text class="state-text" style="fill:#184a5b;" x="600" y="250" font-size="12px">IL</text>
            <path
                style="fill:#ffffff;fill-opacity:1;stroke:#184a5b;stroke-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="CT" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="855" y="175" font-size="12px">CT</text>
            <path class="state"
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="WI" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="580" y="180" font-size="12px">WI</text>
            <path class="state"
                style="fill:#ffffff;fill-opacity:1;stroke:#184a5b;stroke-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="NC" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="785" y="330" font-size="12px">NC</text>
                <path class="state"
                style="fill:#ffffff;fill-opacity:1;stroke:#184a5b;stroke-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="DC" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="806" y="254" font-size="9px">DC</text>
            <path
                style="fill:#ffffff;fill-opacity:1;stroke:#184a5b;stroke-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="MA" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="860" y="160" font-size="12px">MA</text>
            <path
                style="fill:#ffffff;fill-opacity:1;stroke:#184a5b;stroke-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="TN" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="670" y="340" font-size="12px">TN</text>
            <path
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="AR" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="545" y="375" font-size="12px">AR</text>
            <path
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="MO" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="535" y="295" font-size="12px">MO</text>
            <path
                style="fill:#ffffff;fill-opacity:1;stroke:#184a5b;stroke-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="GA" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="710" y="410" font-size="12px">GA</text>
            <path
                style="fill:#ffffff;fill-opacity:1;stroke:#184a5b;stroke-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="SC" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="750" y="380" font-size="12px">SC</text>
            <path
                style="fill:#ffffff;fill-opacity:1;stroke:#184a5b;stroke-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="KY" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="670" y="310" font-size="12px">KY</text>
            <path
                style="fill:#ffffff;fill-opacity:1;stroke:#184a5b;stroke-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="AL" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="650" y="420" font-size="12px">AL</text>
            <path
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="LA" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="550" y="460" font-size="12px">LA</text>
            <path class="state"
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="MS"
                ...
                sodipodi:nodetypes="ccccccccccccccccccccccccccccccccccccccccccccccccccc" />
                <text class="state-text" style="fill:#184a5b;" x="600" y="420" font-size="12px">MS</text>
            <path class="state"
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="IA"
                ...
                <text class="state-text" style="fill:#184a5b;" x="512" y="219" font-size="12px">IA</text>
            <path class="state"
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="MN"
                ...
                <text class="state-text" style="fill:#184a5b;" x="495" y="128" font-size="12px">MN</text>
            <path class="state"
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="OK" class="state"
                ...
                sodipodi:nodetypes="ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc" />
                <text class="state-text" style="fill:#184a5b;" x="440" y="360" font-size="12px">OK</text>
            <path
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="TX" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="420" y="450" font-size="12px">TX</text>
            <path
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="NM" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="290" y="380" font-size="12px">NM</text>
            <path
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="KS" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="440" y="300" font-size="12px">KS</text>
            <path
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="NE" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="420" y="220" font-size="12px">NE</text>
            <path
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="SD" class="state"
                ...
                sodipodi:nodetypes="ccccccccccccccccccccccccccccccccccccc" />
                <text class="state-text" style="fill:#184a5b;" x="420" y="160" font-size="12px">SD</text>
            <path
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="ND" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="405" y="95" font-size="12px">ND</text>
            <path
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="WY" class="state"
                d="M 360.37668,143.27587 L 253.63408,129.81881 L 239.5506,218.27684 L 352.81521,231.86233 L 360.37668,143.27587 z"
                sodipodi:nodetypes="ccccc" />
                <text class="state-text" style="fill:#184a5b;" x="300" y="180" font-size="12px">WY</text>
            <path
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="MT" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="300" y="90" font-size="12px">MT</text>
            <path
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="CO" class="state"
                d="M 380.03242,320.96457 L 384.93566,234.63961 L 271.5471,221.99565 L 259.33328,309.93481 L 380.03242,320.96457 z"
                sodipodi:nodetypes="ccccc" />
                <text class="state-text" style="fill:#184a5b;" x="320" y="275" font-size="12px">CO</text>
            <path
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="ID" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="196" y="155" font-size="12px">ID</text>
            <path
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="UT" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="230" y="270" font-size="12px">UT</text>
            <path
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="AZ" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="200" y="370" font-size="12px">AZ</text>
            <path
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="NV" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="140" y="255" font-size="12px">NV</text>
            <path
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="OR" class="state"
                ...
                sodipodi:nodetypes="ccccccccccccccccccccccccccccccccccccccccccccccccccc" />
                <text class="state-text" style="fill:#184a5b;" x="99" y="139" font-size="12px">OR</text>
            <path
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="WA" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="122" y="60" font-size="12px">WA</text>
                <path
                style="fill:#ffffff;stroke:#184a5b;stroke-opacity:1;fill-opacity:1;stroke-width:0.75;stroke-miterlimit:4;stroke-dasharray:none"
                id="CA" class="state"
                ...
                <text class="state-text" style="fill:#184a5b;" x="90" y="300" font-size="12px">CA</text>
            </svg>
        </div>
                <div id="state-error" style="color: red; display: none;">Please select a state before continuing.</div>
                <script>
    // Wait for the document to load before attaching event listeners

document.addEventListener("DOMContentLoaded", function() {
    // Variables to hold selected states and display in the form
    let selectedStates = [];

    // Capture clicks on state paths
    document.querySelectorAll('.state').forEach(function(state) {
        state.addEventListener('click', function() {
            // Toggle state selection
            if (selectedStates.includes(state.id)) {
                selectedStates = selectedStates.filter(item => item !== state.id); // Remove state
            } else {
                selectedStates.push(state.id); // Add state
            }
            // Update the display with selected states
            document.getElementById('state-name').innerText = selectedStates.join(', ');

            // Set the value in the hidden input field for form submission
            document.getElementById('selected-state').value = selectedStates.join(', ');
        });
    });
});
                </script>
...
.state.active {
  fill: green !important;
                ...
                <button type="button" id="continue-btn-6">Continue</button>
                </div>
            </form>
        </div>
        <!-- Step 7: Payment Preference Form -->
        <div id="step-7" class="form-step" style="display: none;">
        <h2>Create your Ensite account</h2>
        <p class="main-question">In general, how does your company prefer to pay for things? <br>
            <small>(You can change this later)</small></p>
            <form method="POST" onsubmit="saveData(event)">
                <button type="button" class="option-btn" onclick="selectPaymentMethod('Bulk purchasing for the most savings')">
                <svg width="20" height="20" viewBox="0 0 19 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M6.85106 39.624C5.31506 39.56 4.00306 39.368 2.91506 39.048C1.82706 38.76 0.963063 38.408 0.323063 37.992L1.90706 32.856C2.38706 33.208 3.04306 33.528 3.87506 33.816C4.73906 34.104 5.73106 34.312 6.85106 34.44V23.88C6.01906 23.4 5.20306 22.872 4.40306 22.296C3.60306 21.72 2.88306 21.048 2.24306 20.28C1.63506 19.48 1.12306 18.568 0.707062 17.544C0.323063 16.488 0.131063 15.24 0.131063 13.8C0.131063 11.304 0.739063 9.336 1.95506 7.896C3.17106 6.424 4.80306 5.464 6.85106 5.016V0.599999H11.4111V4.824C12.5311 4.888 13.5231 5.048 14.3871 5.304C15.2511 5.528 16.0671 5.832 16.8351 6.216L15.2511 11.208C14.7711 10.952 14.2111 10.728 13.5711 10.536C12.9311 10.312 12.2111 10.152 11.4111 10.056V19.512C12.2431 20.024 13.0591 20.584 13.8591 21.192C14.6911 21.768 15.4271 22.456 16.0671 23.256C16.7391 24.056 17.2831 24.968 17.6991 25.992C18.1151 27.016 18.3231 28.216 18.3231 29.592C18.3231 32.344 17.6991 34.52 16.4511 36.12C15.2031 37.72 13.5231 38.776 11.4111 39.288V43.8H6.85106V39.624ZM9.44306 34.392C10.4671 34.2 11.2351 33.736 11.7471 33C12.2591 32.232 12.5151 31.304 12.5151 30.216C12.5151 29.128 12.2271 28.232 11.6511 27.528C11.0751 26.792 10.3391 26.12 9.44306 25.512V34.392ZM8.86706 9.96C7.71506 10.088 6.91506 10.504 6.46706 11.208C6.05106 11.88 5.84306 12.616 5.84306 13.416C5.84306 14.408 6.13106 15.256 6.70706 15.96C7.28306 16.632 8.00306 17.272 8.86706 17.88V9.96Z" fill="#4F7B8A"/>
                </svg>Bulk purchasing for the most savings</button>
                <button type="button" class="option-btn" onclick="selectPaymentMethod('Pay as you go for convenience')">
                <svg width="20" height="20" viewBox="0 0 42 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M7.39013 39.624C5.85413 39.56 4.54213 39.368 3.45413 39.048C2.36613 38.76 1.50213 38.408 0.862125 37.992L2.44613 32.856C2.92613 33.208 3.58213 33.528 4.41412 33.816C5.27813 34.104 6.27013 34.312 7.39013 34.44V23.88C6.55813 23.4 5.74213 22.872 4.94213 22.296C4.14213 21.72 3.42213 21.048 2.78213 20.28C2.17413 19.48 1.66213 18.568 1.24612 17.544C0.862125 16.488 0.670125 15.24 0.670125 13.8C0.670125 11.304 1.27813 9.336 2.49413 7.896C3.71013 6.424 5.34213 5.464 7.39013 5.016V0.599999H11.9501V4.824C13.0701 4.888 14.0621 5.048 14.9261 5.304C15.7901 5.528 16.6061 5.832 17.3741 6.216L15.7901 11.208C15.3101 10.952 14.7501 10.728 14.1101 10.536C13.4701 10.312 12.7501 10.152 11.9501 10.056V19.512C12.7821 20.024 13.5981 20.584 14.3981 21.192C15.2301 21.768 15.9661 22.456 16.6061 23.256C17.2781 24.056 17.8221 24.968 18.2381 25.992C18.6541 27.016 18.8621 28.216 18.8621 29.592C18.8621 32.344 18.2381 34.52 16.9901 36.12C15.7421 37.72 14.0621 38.776 11.9501 39.288V43.8H7.39013V39.624ZM9.98213 34.392C11.0061 34.2 11.7741 33.736 12.2861 33C12.7981 32.232 13.0541 31.304 13.0541 30.216C13.0541 29.128 12.7661 28.232 12.1901 27.528C11.6141 26.792 10.8781 26.12 9.98213 25.512V34.392ZM9.40613 9.96C8.25413 10.088 7.45413 10.504 7.00613 11.208C6.59013 11.88 6.38213 12.616 6.38213 13.416C6.38213 14.408 6.67013 15.256 7.24613 15.96C7.82213 16.632 8.54213 17.272 9.40613 17.88V9.96ZM30.312 39.624C28.776 39.56 27.464 39.368 26.376 39.048C25.288 38.76 24.424 38.408 23.784 37.992L25.368 32.856C25.848 33.208 26.504 33.528 27.336 33.816C28.2 34.104 29.192 34.312 30.312 34.44V23.88C29.48 23.4 28.664 22.872 27.864 22.296C27.064 21.72 26.344 21.048 25.704 20.28C25.096 19.48 24.584 18.568 24.168 17.544C23.784 16.488 23.592 15.24 23.592 13.8C23.592 11.304 24.2 9.336 25.416 7.896C26.632 6.424 28.264 5.464 30.312 5.016V0.599999H34.872V4.824C35.992 4.888 36.984 5.048 37.848 5.304C38.712 5.528 39.528 5.832 40.296 6.216L38.712 11.208C38.232 10.952 37.672 10.728 37.032 10.536C36.392 10.312 35.672 10.152 34.872 10.056V19.512C35.704 20.024 36.52 20.584 37.32 21.192C38.152 21.768 38.888 22.456 39.528 23.256C40.2 24.056 40.744 24.968 41.16 25.992C41.576 27.016 41.784 28.216 41.784 29.592C41.784 32.344 41.16 34.52 39.912 36.12C38.664 37.72 36.984 38.776 34.872 39.288V43.8H30.312V39.624ZM32.904 34.392C33.928 34.2 34.696 33.736 35.208 33C35.72 32.232 35.976 31.304 35.976 30.216C35.976 29.128 35.688 28.232 35.112 27.528C34.536 26.792 33.8 26.12 32.904 25.512V34.392ZM32.328 9.96C31.176 10.088 30.376 10.504 29.928 11.208C29.512 11.88 29.304 12.616 29.304 13.416C29.304 14.408 29.592 15.256 30.168 15.96C30.744 16.632 31.464 17.272 32.328 17.88V9.96Z" fill="#4F7B8A"/>
                </svg>Pay as you go for convenience</button>
                <button type="button" class="option-btn" onclick="selectPaymentMethod('Net payment terms even if it is the most expensive')">
                <svg width="30" height="20" viewBox="0 0 65 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M6.92919 39.624C5.39319 39.56 4.08119 39.368 2.99319 39.048C1.90519 38.76 1.04119 38.408 0.401188 37.992L1.98519 32.856C2.46519 33.208 3.12119 33.528 3.95319 33.816C4.81719 34.104 5.80919 34.312 6.92919 34.44V23.88C6.09719 23.4 5.28119 22.872 4.48119 22.296C3.68119 21.72 2.96119 21.048 2.32119 20.28C1.71319 19.48 1.20119 18.568 0.785187 17.544C0.401188 16.488 0.209188 15.24 0.209188 13.8C0.209188 11.304 0.817188 9.336 2.03319 7.896C3.24919 6.424 4.88119 5.464 6.92919 5.016V0.599999H11.4892V4.824C12.6092 4.888 13.6012 5.048 14.4652 5.304C15.3292 5.528 16.1452 5.832 16.9132 6.216L15.3292 11.208C14.8492 10.952 14.2892 10.728 13.6492 10.536C13.0092 10.312 12.2892 10.152 11.4892 10.056V19.512C12.3212 20.024 13.1372 20.584 13.9372 21.192C14.7692 21.768 15.5052 22.456 16.1452 23.256C16.8172 24.056 17.3612 24.968 17.7772 25.992C18.1932 27.016 18.4012 28.216 18.4012 29.592C18.4012 32.344 17.7772 34.52 16.5292 36.12C15.2812 37.72 13.6012 38.776 11.4892 39.288V43.8H6.92919V39.624ZM9.52119 34.392C10.5452 34.2 11.3132 33.736 11.8252 33C12.3372 32.232 12.5932 31.304 12.5932 30.216C12.5932 29.128 12.3052 28.232 11.7292 27.528C11.1532 26.792 10.4172 26.12 9.52119 25.512V34.392ZM8.94519 9.96C7.79319 10.088 6.99319 10.504 6.54519 11.208C6.12919 11.88 5.92119 12.616 5.92119 13.416C5.92119 14.408 6.20919 15.256 6.78519 15.96C7.36119 16.632 8.08119 17.272 8.94519 17.88V9.96ZM29.8511 39.624C28.3151 39.56 27.0031 39.368 25.9151 39.048C24.8271 38.76 23.9631 38.408 23.3231 37.992L24.9071 32.856C25.3871 33.208 26.0431 33.528 26.8751 33.816C27.7391 34.104 28.7311 34.312 29.8511 34.44V23.88C29.0191 23.4 28.2031 22.872 27.4031 22.296C26.6031 21.72 25.8831 21.048 25.2431 20.28C24.6351 19.48 24.1231 18.568 23.7071 17.544C23.3231 16.488 23.1311 15.24 23.1311 13.8C23.1311 11.304 23.7391 9.336 24.9551 7.896C26.1711 6.424 27.8031 5.464 29.8511 5.016V0.599999H34.4111V4.824C35.5311 4.888 36.5231 5.048 37.3871 5.304C38.2511 5.528 39.0671 5.832 39.8351 6.216L38.2511 11.208C37.7711 10.952 37.2111 10.728 36.5711 10.536C35.9311 10.312 35.2111 10.152 34.4111 10.056V19.512C35.2431 20.024 36.0591 20.584 36.8591 21.192C37.6911 21.768 38.4271 22.456 39.0671 23.256C39.7391 24.056 40.2831 24.968 40.6991 25.992C41.1151 27.016 41.3231 28.216 41.3231 29.592C41.3231 32.344 40.6991 34.52 39.4511 36.12C38.2031 37.72 36.5231 38.776 34.4111 39.288V43.8H29.8511V39.624ZM32.4431 34.392C33.4671 34.2 34.2351 33.736 34.7471 33C35.2591 32.232 35.5151 31.304 35.5151 30.216C35.5151 29.128 35.2271 28.232 34.6511 27.528C34.0751 26.792 33.3391 26.12 32.4431 25.512V34.392ZM31.8671 9.96C30.7151 10.088 29.9151 10.504 29.4671 11.208C29.0511 11.88 28.8431 12.616 28.8431 13.416C28.8431 14.408 29.1311 15.256 29.7071 15.96C30.2831 16.632 31.0031 17.272 31.8671 17.88V9.96ZM52.7729 39.624C51.2369 39.56 49.9249 39.368 48.8369 39.048C47.7489 38.76 46.8849 38.408 46.2449 37.992L47.8289 32.856C48.3089 33.208 48.9649 33.528 49.7969 33.816C50.6609 34.104 51.6529 34.312 52.7729 34.44V23.88C51.9409 23.4 51.1249 22.872 50.3249 22.296C49.5249 21.72 48.8049 21.048 48.1649 20.28C47.5569 19.48 47.0449 18.568 46.6289 17.544C46.2449 16.488 46.0529 15.24 46.0529 13.8C46.0529 11.304 46.6609 9.336 47.8769 7.896C49.0929 6.424 50.7249 5.464 52.7729 5.016V0.599999H57.3329V4.824C58.4529 4.888 59.4449 5.048 60.3089 5.304C61.1729 5.528 61.9889 5.832 62.7569 6.216L61.1729 11.208C60.6929 10.952 60.1329 10.728 59.4929 10.536C58.8529 10.312 58.1329 10.152 57.3329 10.056V19.512C58.1649 20.024 58.9809 20.584 59.7809 21.192C60.6129 21.768 61.3489 22.456 61.9889 23.256C62.6609 24.056 63.2049 24.968 63.6209 25.992C64.0369 27.016 64.2449 28.216 64.2449 29.592C64.2449 32.344 63.6209 34.52 62.3729 36.12C61.1249 37.72 59.4449 38.776 57.3329 39.288V43.8H52.7729V39.624ZM55.3649 34.392C56.3889 34.2 57.1569 33.736 57.6689 33C58.1809 32.232 58.4369 31.304 58.4369 30.216C58.4369 29.128 58.1489 28.232 57.5729 27.528C56.9969 26.792 56.2609 26.12 55.3649 25.512V34.392ZM54.7889 9.96C53.6369 10.088 52.8369 10.504 52.3889 11.208C51.9729 11.88 51.7649 12.616 51.7649 13.416C51.7649 14.408 52.0529 15.256 52.6289 15.96C53.2049 16.632 53.9249 17.272 54.7889 17.88V9.96Z" fill="#4F7B8A"/>
                </svg>Net payment terms even if it is the most expensive</button>
                <div id="payment-method-error" style="color: red; display: none;">Please select a payment method before continuing.</div>
                <div class="buttons-back-continue">
                <button type="button" onclick="prevStep(6)">Back</button>
                <button type="button" id="continue-btn-7">Continue</button>
                </div>
            </form>
        </div>
        ...
        <h2>Create your Ensite account</h2>
        <p class="main-question">(Last Question) About how many orders do you anticipate making per month?<br>(You can change this later)</p>
            <form method="POST" onsubmit="saveData(event)">
                <div id="selected-services-dropdowns">
                    <!-- Selected services will be displayed here -->
                </div>
                <div class="buttons-back-continue">
                <button type="button" onclick="prevStep(7)">Back</button>
                <!-- <button type="button" onclick="nextStep(9)" id="continue-button-8">Continue</button> -->
                <button type="button" onclick="showLoaderAndProceed()">Continue</button>
                </div>
            </form>
        </div>

        <div id="step-9" class="form-step" style="display:none;">
            <p class="main-question">Select your pricing plan</p>
            <form method="POST" onsubmit="saveData(event)">
                <h4 class="recommed-title" style="text-align:center;">Recommended</h4>
                <div class="pricing-plans" id="pricing-plans">
                    <div class="pricing-plan" id="plan-standard">
                        <h4 class="pricing-plan-heading">NET-15 PAYMENT</h4>
                        <div class="pricing-plan-monthly"><p>Monthly Order Qty. <div class="range-total-display"></div></p></div>
                        <p class="para-monthly" data-service="Site Surveys"><span><sup>$</sup></span> 400<sub>/survey</sub></p>
                        <p class="para-monthly" data-service="Design & Engineering"><span><sup>$</sup></span> 165<sub>/design</sub></p>
                        <p class="para-monthly" data-service="Permitting & Interconnection"><span><sup>$</sup></span> 300<sub>/permit + ic</sub></p>
                        <p class="para-monthly" data-service="Final Inspection Sits"><span><sup>$</sup></span> 400*<sub>/final inspection</sub></p>
                        <button type="button" onclick="selectPricingPlan('NET-15 PAYMENT')">Select Plan & Continue</button>
                        <p class="para-last">Conditions: business credit check required. Work will cease if payment is not received as scheduled.</p>
                    </div>
                    <div class="pricing-plan" id="plan-basic">
                        <p class="pricing-plan-para"><small>BEST DEAL FOR HIGHEST SAVINGS</small></p>
                        <h4 class="pricing-plan-heading">VALUE PACKAGE</h4>
                        <div class="pricing-plan-monthly"><p>Monthly Order Qty. <div class="range-total-display"></div></p></div>
                        <p class="para-monthly" data-service="Site Surveys"><span><sup>$</sup></span> 315<sub>/survey</sub></p>
                        <p class="para-monthly" data-service="Design & Engineering"><span><sup>$</sup></span> 125<sub>/design</sub></p>
                        <p class="para-monthly" data-service="Permitting & Interconnection"><span><sup>$</sup></span> 275<sub>/permit + ic</sub></p>
                        <p class="para-monthly" data-service="Final Inspection Sits"><span><sup>$</sup></span> 315<sub>/final inspection</sub></p>
                        <button type="button" onclick="selectPricingPlan('VALUE PACKAGE')">Select Plan & Continue</button>
                        <p class="para-last">Conditions: minimum order qty. of 50 units required</p>
                    </div>
                    <div class="pricing-plan" id="plan-premium">
                    <p class="pricing-plan-para"><small>Most Popular</small></p>
                        <h4 class="pricing-plan-heading">CONVENIENCE PACKAGE</h4>
                        <div class="pricing-plan-monthly"><p>Monthly Order Qty. <div class="range-total-display"></div></p></div>
                        <p class="para-monthly" data-service="Site Surveys"><span><sup>$</sup></span> 350<sub>/survey</sub></p>
                        <p class="para-monthly" data-service="Design & Engineering"><span><sup>$</sup></span> 135<sub>/design</sub></p>
                        <p class="para-monthly" data-service="Permitting & Interconnection"><span><sup>$</sup></span> 250<sub>/permit + ic</sub></p>
                        <p class="para-monthly" data-service="Final Inspection Sits"><span><sup>$</sup></span> 350*<sub>/final inspection</sub></p>
                        <button type="button" onclick="selectPricingPlan('CONVENIENCE PACKAGE')">Select Plan & Continue</button>
                        <p class="para-last">Conditions: each unit purchased before work is started</p>
                    </div>
                </div>
                <div class="buttons-back-continue">
                <button type="button" onclick="prevStep(8)">Back</button>
                <button type="button" onclick="nextStep(10)" id="continue-buton-9">Continue</button>
                </div>
            </form>
        </div>
        ...
        <div id="step-10" class="form-step" style="display: none;">
            <h2>Please check your email</h2>
                <p>Please check your email for a service agreement from PandaDoc. Once it is signed, you will be sent your portal logion credentials.</p>
            <form method="POST" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" id="final-form">
                <input type="hidden" name="action" value="wpmsf_save_form_data">
                <input type="hidden" name="business_type" id="business_type_hidden">
                ...
                <input type="hidden" name="services" id="services_hidden">
                <input type="hidden" name="survey_method" id="survey_method_hidden">
                <input type="hidden" name="important_aspects" id="important_aspects_hidden">
                <!-- <input type="hidden" name="selected_state" id="selected-state-hidden"> -->
                <input type="hidden" id="selected-state-hidden" name="selected_state" />

                <input type="hidden" name="payment_method" id="payment_method_hidden">
                <input type="hidden" name="orders_per_month" id="orders_per_month_hidden">
                <input type="hidden" name="selected_pricing_plan" id="selected_pricing_plan_hidden">

                <!-- <button type="button" onclick="prevStep(9)">Back</button> -->
                <button type="button" id="submit-btn" onclick="submitForm()">Finish</button>
            </form>
        </div>
        <div id="loader" style="display: none;">
            <div class="loader-overlay">
                <div class="loader-content">
                    ...
                    <p>We are almost done, we just need a few more details so that we can generate a pricing package for you</p>
                </div>
            </div>
        </div>
...
add_shortcode('wpmsf_multi_form', 'wpmsf_display_form');

function wpmsf_handle_form_submission() {
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['selected_state'])) {
        global $wpdb;
        ...
        $survey_method = sanitize_textarea_field($_POST['survey_method']);
        $important_aspects = sanitize_textarea_field($_POST['important_aspects']);
        $selected_state = sanitize_text_field($_POST['selected_state']);
        $payment_method = sanitize_text_field($_POST['payment_method']);
        $orders_per_month = sanitize_text_field($_POST['orders_per_month']);
        $selected_pricing_plan = sanitize_text_field($_POST['selected_pricing_plan']);
        
        // Insert data into the database
        $table_name = $wpdb->prefix . 'multiform_data';
...
add_action('init', 'wpmsf_handle_form_submission');
